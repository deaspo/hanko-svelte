...
<section id="property" class=" px-6 pt-12 bg-gray-100">
	<div class="grid max-w-screen-xl py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-0 lg:pt-16 lg:grid-cols-12">
		<div class="w-full lg:col-span-full">
			<h1
				class="text-center mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl"
			>
				Find Property
			</h1>
			<form>
